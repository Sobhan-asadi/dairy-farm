...
import { CareerSchema, type CareerFormValues } from "@/lib/validations/career";
  ...
  return (
    ...
    >
      <FieldGroup>
        ...
        <Field>
          <FieldLabel htmlFor="message">توضیحات (اختیاری)</FieldLabel>
        ...
        <Field>
          <FieldLabel htmlFor="resume">رزومه</FieldLabel>
          ...
          <p className="text-muted-foreground text-xs">
            فرمت‌های مجاز: PDF، DOC و DOCX — حداکثر ۵ مگابایت
          </p>
