...
type CareerApplicationsPaginationProps = {
  currentPage: number;
  totalPages: number;
};
...
export function CareerApplicationsPagination({
  currentPage,
  totalPages,
}: CareerApplicationsPaginationProps) {
  ...
  const createPageHref = (page: number) => {
    ...
    return `/admin/careers?${params.toString()}`;
  };
